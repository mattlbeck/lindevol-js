...
| :--- | :--- | :--- |
| **Steps Per Frame** (`steps_per_frame`) | `number` | The number of simulation steps to compute before drawing the frame to the screen. Increase this to uncap simulation speed. |
